Feature: Allows an user to look at a glance your cholesterol-ldl data
    Eu, como usuário cadastrado
    Devo conseguir visualizar os meus valores de colesterol-ldl na minha página inicial
